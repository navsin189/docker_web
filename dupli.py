...
body{
	background-image:url('wallpaperswide.com/download/stay_at_home_biohazard_warning-wallpaper-1366x768.jpg');
}
...
w=cgi.FieldStorage()
a=w.getvalue("code")
file1=open(r"/var/www/html/anime/ty.py","w")
file1.writelines(a)
file1.close()
op=subprocess.getoutput("python3  /var/www/html/anime/ty.py")
print("")
print("the output:\t",op)
d='''
<style>
